                            ...
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 lg:col-span-3">
                                    ...
                                    <div class="relative mb-6">
                                        <div class="flex">
                                            ...
                                            <p class="font-medium text-sm text-blue-600" id="progressText">->&nbsp;{{ $laporan->kgtn_tercapai }}%</p>
                                        </div>
                                        <input name="kgtn_tercapai" id="range-input" type="range" min="0" max="100" 
                                ...
                                <div class="col-span-6 lg:col-span-3">
                                    ...
                                    <div class="flex text-blue-400 hover:text-blue-700 font-bold">
                                        ...
                                        <a href="/manager/datalaporan/view/{{ $laporan->id_kegiatan }}">{{ $laporan->buktifoto }}</a>
                                    </div>
                                </div>
                                <div class="col-span-6 lg:col-span-3">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('buktifoto') }}">
                                    <div class="flex text-gray-900 hover:text-gray-700">
                                        ...
                                        <a href="/manager/datalaporan/view/">template_dokumentasi.docx</a>
                                    </div>
                                </div>
                                <div class="col-span-6">
                                    <hr>
                                ...
                                <div class="col-span-6">
                                    ...
                                    <textarea class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-300 focus:border-blue-300 block w-full p-2.5"
                                    name="komentar" id="komentar" placeholder="Silahkan berkomentar ketika ada Revisi!">{{ $laporan->komentar ?? old('komentar') }}</textarea>
                                </div>
                                ...
                                <div class="col-span-6 pt-2 border-gray-200 rounded-b flex">
                                    <button class="flex items-center justify-center text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:ring-blue-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="submit" formaction="/manager/datalaporan/terima/{{ $laporan->id_kegiatan }}">
                                    ...
                                    <button class="flex items-center justify-center text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:ring-blue-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center ml-2" type="submit" formaction="/manager/datalaporan/revisi/{{ $laporan->id_kegiatan }}">
                                        <svg class="w-6 h-6 text-white mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                            <path fill-rule="evenodd" d="M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12Zm9.408-5.5a1 1 0 1 0 0 2h.01a1 1 0 1 0 0-2h-.01ZM10 10a1 1 0 1 0 0 2h1v3h-1a1 1 0 1 0 0 2h4a1 1 0 1 0 0-2h-1v-4a1 1 0 0 0-1-1h-2Z" clip-rule="evenodd"/>
                                        </svg>                                          
                                        Revisi
