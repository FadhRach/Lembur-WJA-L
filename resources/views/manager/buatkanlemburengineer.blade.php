...
<body>
    ...
    <div class="p-4 sm:ml-64">
        <div  class="p-4 mt-14">
            <main class="w-full flex-grow">
                <h1 class="text-3xl text-black pb-6">Buatkan Lembur Untuk Engineer</h1>
                
                <div class="bg-white border rounded-lg relative">
                    <div class="p-6 space-y-6">
                        <form action="/manager/buatkanlembur/engineersave" method="POST"  enctype="multipart/form-data">
                            {{ csrf_field() }} @csrf
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                @if ($errors->has('ptgs_manager'))
                                    <div class="block w-full text-sm text-red-800 dark:bg-gray-800" role="alert">
                                     ...
                                     @endif
                                <div class="col-span-6 lg:col-span-3">
                                    <label for="id_user" class="text-sm font-medium text-gray-900 block mb-2">Karyawan Engineer</label>
                                ...
                                <div class="col-span-6 lg:col-span-2">
                                    <label for="kegiatan" class="text-sm font-medium text-gray-900 block mb-2">Judul Kegiatan</label>
                                    ...
                                    type="text" name="kegiatan" placeholder="Judul Lembur" value="{{ old('kegiatan') }}">
                                ...
                                <div class="col-span-6 lg:col-span-2">
                                    <label for="tgl_awal" class="text-sm font-medium text-gray-900 block mb-2">Waktu Kegiatan Awal</label>
                                    <input class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-300 focus:border-blue-300 block w-full p-2.5"
                                    type="datetime-local" name="tgl_awal" id="tgl_awal" placeholder="Dari Kapan" value="{{ old('tgl_awal') }}">
                                ...
                                <div class="col-span-6 lg:col-span-2">
                                    <label for="tgl_akhir" class="text-sm font-medium text-gray-900 block mb-2">Waktu Kegiatan Akhir</label>
                                    <input class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-300 focus:border-blue-300 block w-full p-2.5"
                                    type="datetime-local" name="tgl_akhir" id="tgl_akhir" placeholder="Sampai Kapan" value="{{ old('tgl_akhir') }}">
                                ...
                                <div class="col-span-6 lg:col-span-2">
                                    <label for="lama_kegiatan" class="text-sm font-medium text-gray-900 block mb-2">Lama Kegiatan</label>
                                    <input class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-300 focus:border-blue-300 block w-full p-2.5"
                                    type="text" name="lama_kegiatan" id="lama_kegiatan" placeholder="Judul Lembur" value="{{ old('lama_kegiatan') }}" readonly>
                                ...
                                <div class="col-span-6 lg:col-span-2">
                                    ...
                                    <input class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-300 focus:border-blue-300 block w-full p-2.5"
                                    type="text" name="lokasi" placeholder="Lokasi Lembur" value="{{ old('lokasi') }}">
    ...
    <script>
        ...
        displaySelectedUser(document.getElementById('engineer').value, 'engineer-details', @json($engineer));
