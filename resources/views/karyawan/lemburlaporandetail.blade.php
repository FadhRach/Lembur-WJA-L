                            ...
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 lg:col-span-3">
                                    ...
                                    <div class="flex text-blue-400 hover:text-blue-700 font-bold">
                                        ...
                                        <a href="/karyawan/datalaporan/view/{{ $laporan->id_kegiatan }}">{{ $laporan->buktifoto }}</a>
                                    </div>
                                </div>
                                <div class="col-span-6 lg:col-span-3">
                                ...
                                <div class="col-span-6 pt-2 border-gray-200 rounded-b flex">
                                    <button class="flex items-center justify-center text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="submit" formaction="/karyawan/datalaporan/save/{{ $laporan->id_kegiatan }}">
