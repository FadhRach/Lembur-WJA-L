                            ...
                            <tr class="bg-white border-b hover:bg-gray-50">
                                ...
                                <td class="px-2 py-2 border-r">
                                    <div class="flex justify-center m-5">
                                        <a href="/engineer/datalembur/{{ $keg->id_kegiatan }}" class="block font-medium rounded-lg text-sm px-5 py-2.5 text-center">
