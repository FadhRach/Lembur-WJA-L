            ...
            <main class="w-full flex-grow">
                ...
                <div class="bg-white border rounded-lg relative">
                    <div class="p-6 space-y-6">
                        <form action="/engineer/buatkanlembur/karyawansave" method="POST"  enctype="multipart/form-data">
                            {{ csrf_field() }} @csrf
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                @if ($errors->has('id_user'))
                                    <div class="block w-full text-sm text-red-800 dark:bg-gray-800" role="alert">
                                     ...
                                     @endif
                                <div class="col-span-6 xl:col-span-2">
                                    <label for="id_user" class="text-sm font-medium text-gray-900 block mb-2">Petugas Engineer</label>
                                    ...
                                    <input type="text" name="ptgs_engineer" value="{{ auth::user()->id_user }}" hidden>
                                ...
                                @if ($errors->has('ptgs_engineer'))
                                    <div class="block w-full text-sm text-red-800 dark:bg-gray-800" role="alert">
                                        {{ $errors->first('ptgs_engineer') }}
                                    </div>
                                     @endif
                                <div class="col-span-6 xl:col-span-2">
