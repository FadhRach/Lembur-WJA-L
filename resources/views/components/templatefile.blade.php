...
<body>
    <div class="flex flex-col h-screen">
            ...
            <div class="px-3 py-3 lg:px-5 lg:pl-3">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center">
                        <div class="flex items-center justify-start rtl:justify-end">
                            <a href="/{{ Auth::user()->role }}/datalaporan/{{ $file->id_kegiatan }}">
                        ...
                        <div class="flex items-center ms-3">
                            ...
                            <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow"
                                ...
                                <ul class="py-1" role="none">
                                    <li>
                                        <a href="/engineer/datalaporan" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
        ...
        {{-- IFRAME --}}
        <iframe class="flex-grow" src="{{ asset('dokumentasi/Template_LemburWJA ') }}" frameborder="0"></iframe>
    </div>
